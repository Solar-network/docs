...
<livewire:embed-link url="https://github.com/learn-solar/desktop-wallet-plugin-template" caption="Desktop Wallet Plugin Template Project" />
...
```bash
mv ../my-first-plugin/ ~/.solar-desktop/plugins/
```
...
Congrats you just developed your very first Desktop Wallet plugin! Now it is time to experiment on your own, and don’t forget we have our **[Development Bounty Program](https://bounty.solar.io/)** running, you are more than welcomed to jump in any time.

If you want to learn from already developed plugins for the Desktop Wallet, have a look in our official **[Desktop Plugins repository](https://github.com/solar-ecosystem-desktop-plugins)** which currently consists of these plugins:

* [Explorer plugin](https://github.com/solar-ecosystem-desktop-plugins/explorer)
* [Additional avatars plugin](https://github.com/solar-ecosystem-desktop-plugins/additional-avatars)
* [Dark contrast theme plugin](https://github.com/solar-ecosystem-desktop-plugins/dark-contrast-theme)
* [Sound notification plugin](https://github.com/solar-ecosystem-desktop-plugins/sound-notifications)
