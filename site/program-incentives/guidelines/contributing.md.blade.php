...
While the following guidelines are not an absolute requirement, writing your code by these standards will ensure greater compatibility with the Solar Network and increases the likelihood your pull request will be accepted.
...
* **Don't** send pull requests that improve code readability to your liking. _Follow the standards that are specified in the project. Should you have questions, refer to our existing codebases, or [contact us](https://solar.dev/contact).
...
The SXP Team distances itself from anything that is related to payouts by delegates or voter calculations.
