...
Solar Core Production ready Docker images are now available at [Docker Hub](https://hub.docker.com/r/arkecosystem/core)
</x-alert>
...
### How To Build Your Own Solar Core Docker Image

This requires cloning [Solar Core Github repository](https://github.com/ArkEcosystem/core).
...
Solar Core includes several `Dockerfile` and `docker-compose.yml` templates to ease the development. They can be used to generate different configurations, depending on the network and token.
...
Clone [Solar Core Github repository](https://github.com/ArkEcosystem/core):
...
### **Run a PostgreSQL container, build and run SXP-Core using a mounted volume.**
...
_Enter your solar-core container and use NodeJS in a Docker container (Linux environment) with the following command:_
