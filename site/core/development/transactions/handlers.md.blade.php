...
You can have a look at the full implementation in the [custom transaction github repository](https://github.com/learn-solar/dapp-custom-transaction-example/blob/develop/src/handlers/BusinessRegistrationTransactionHandler.ts).
