...
![The Core GTI Engine Class Diagram Excerpt](/core/assets/technical-overview.png)
...
<x-alert type="success">
By using **The Core GTI Engine you** will be able to follow a streamlined process of creating and securing your new custom transaction type that can be **deployed to any SXP based bridgechain** and managed inside a separate core module (plugin).
</x-alert>
...
### **Seamless Integration With Solar Core API And SDKs:**
...
Your newly implemented transaction type can now be packed into a core dApp  and distributed to any SXP technology-based bridgechain (API and protocol compliant).
