...
<livewire:embed-link url="https://github.com/learn-solar/dapp-core-module-http-server-template" caption="You can use our template project with HTTP server implementation." />
...
<x-alert type="info">
Head over to: [https://github.com/learn-solar/dapp-core-module-http-server-template](https://github.com/learn-solar/dapp-core-module-http-server-template) and create a new module. Your new module will already have a running HTTP server implemented, so all you need to do is add your own routes and load the module in correct network configuration.
</x-alert>
...
```typescript
// source: https://github.com/learn-solar/dapp-core-module-http-server-template/blob/master/src/server.ts#L63
...
Your implemented dApp application leaves and works from the Solar Core blockchain node as an independent Core module.
...
Looking at the source code from the template (file [server.ts](https://github.com/learn-solar/dapp-core-module-http-server-template/blob/dfde8e761c8e904bf40194fa56219ed318b4d85b/src/server.ts#L55-L63)) we registered two endpoints:

* [GET 0.0.0.0:5003/](http://127.0.0.1:5003)
* [GET 0.0.0.0:5003/config](http://127.0.0.1:5003/config)

The default greeting endpoint was registered and implemented directly from the method in [server.ts](https://github.com/learn-solar/dapp-core-module-http-server-template/blob/dfde8e761c8e904bf40194fa56219ed318b4d85b/src/server.ts#L55-L61).

The configuration endpoint was registered from the [server.ts](https://github.com/learn-solar/dapp-core-module-http-server-template/blob/master/src/server.ts#L63), but the implementation is in the [handlers.ts](https://github.com/learn-solar/dapp-core-module-http-server-template/blob/dfde8e761c8e904bf40194fa56219ed318b4d85b/src/handlers.ts#L4-L28) file. We have split the logic into route registrations and actual implementations.

<x-alert type="success">
You saw how easy it is to add new application/modules and register them on blockchain, making them available to everyone, secure and scalable by default - being powered by SXP Blockchain Core Platform.
</x-alert>

Continue to play around and start implementing your own application, supported by custom API, all packed within the Solar Core module concept, and still fully compatible with our bridgechain ecosystem.
