...
Solar Core has an extensive and powerful plugin system that allows you to very easily break your application up into isolated pieces of business logic, and reusable utilities - **modules**. Modular structure enables developers to focus on writing reusable application logic instead of spending time thinking about software architecture.
...
**It is essential for you to understand and master the art of Solar Core Module development.**
</x-alert>
...
<livewire:embed-link url="https://github.com/learn-solar/dapp-v3-custom-transaction-example/tree/update" caption="dApp Starter Template Project" />

<livewire:embed-link url="https://github.com/learn-solar/dapp-core-module-http-server-template" caption="dApp Starter Template Project With HTTP Server Implementation" />

<x-alert type="info">
Every template is based on the [dApp Starter Core Module Template](https://github.com/learn-solar/dapp-core-module-template/tree/develop) with additional implementation. Use the templates as a functional skeleton project and continue adding and implementing your own logic (API, additional database, voting, loyalty, defi...).
</x-alert>
