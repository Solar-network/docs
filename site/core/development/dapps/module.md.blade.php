...
Many components are required to have a proper environment setup for the development of your Solar Core module. You can view instructions on how to setup your development environment here:
...
<x-alert type="info">
GitHub learning repository has [a starter module template project available](https://github.com/learn-solar/dapp-core-module-template/tree/develop). You can create a new module by creating [a new GitHub repository](https://github.com/new) and selecting the correct template: **learn-solar/dapp-core-module-template.**
</x-alert>

<livewire:embed-link url="https://github.com/learn-solar/dapp-core-module-template/tree/develop" caption="dApp Core Module Starter Template" />
...
* [package.json](https://github.com/learn-solar/dapp-core-module-template/blob/develop/package.json) (model name, dependencies and other npm fields)
* [src/defaults.ts](https://github.com/learn-solar/dapp-core-module-template/blob/develop/src/defaults.ts) (settings)
* [src/index.ts](https://github.com/learn-solar/dapp-core-module-template/blob/develop/src/index.ts) (exports)
* [src/service-provider.ts](https://github.com/learn-solar/dapp-core-module-template/blob/develop/src/service-provider.ts) (registration logic)
...
**Congratulations**. Your first distributed blockchain application is loaded, running and compatible with any Solar Core based blockchain.
</x-alert>
