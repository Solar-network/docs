...
![](/core/assets/cloudflare_dns.png)

Then go to `Crypto`.

![](/core/assets/cloudflare_crypto.png)
...
![](/core/assets/cloudflare_certificate.png)

Open Terminal on your SXP node server
...
If everything started fine, you should be able to access your SXP node APIs behind SSL. Giving you the bonus of Cloudflare DDOS protection.
