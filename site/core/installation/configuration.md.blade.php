...
Solar Core provides a wide variety of ways to configure how it behaves, what plugins are used, who is forging and more. Each option is documented, so head over to the [Solar Core repository](https://github.com/ArkEcosystem/core/) and dive in. All of this configuration can be found in the `app.json`, `delegates.json` and `peers.json` files of the respective network you are using.
