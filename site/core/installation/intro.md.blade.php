...
<x-alert type="info">
These tutorials are for **setting up the development environment** for SXP core. If you are looking to run a core node in production, we provide other tools and resources, such as:

* [SXP Deployer](https://solar.io/deployer) - Create Blockchain in Minutes
