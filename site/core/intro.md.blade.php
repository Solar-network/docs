---
title: Welcome to Solar Core v3
---

# Welcome to Solar Core v3

## Overview

The **Overview** section will introduce you to the basic concepts surrounding Solar Core v3 development.
...
The **Architecture** section will introduce you to the most important concepts and internals of Solar Core v3.
...
The **Services** section will introduce you to pre-built services that you will be able to leverage to speed up Solar Core v3 development.
...
The **Transactions** section will guide you through the most important concepts, internals, and services that you need to understand for implementing and using Solar Core v3 Transactions.
...
The **Installation** section will guide you through configuring and installing Solar Core v3 using Unix and Windows-based environments, including the use of [Docker](https://www.docker.com/).
...
The **Security** section will guide you through the most important concepts and service you can use to improve the security of your Solar Core v3 node.
...
The **Deployment** section will guide you through important actions such as the launching and maintaining of your Solar Core v3 node.
...
The **Development Guides** section will guide you, step-by-step, through customizing essential Solar Core v3 plugins and services.
...
The **Testing** section will introduce you to the most importing tools and knowledge needed to test Solar Core v3 and it's plugins and services.
...
The **Releases** section provides important Solar Core release and upgrade information.
...
The **Support** section provides resources for solving and reporting issues in Solar Core v3.

<x-link-collection
    :links="[
        ['path' => '/docs/core/support/troubleshooting', 'name' => 'Troubleshooting'],
        ['path' => '/docs/core/support/security', 'name' => 'Security Vulnerabilities'],
        ['path' => 'https://solar.dev/contact', 'name' => 'Contact Us'],
    ]"
/>
