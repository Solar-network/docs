...
Solar Core V3 is currently available for testing on the SXP Development Network (ADN). V3 is a major milestone for Solar Core that finally provides a fully modular architecture that lets developers customize their chain to fit their application’s specific needs. While Core v2 provided the initial push towards being fully modular, some elements of prior Solar Core versions were still intertwined to the point where small modifications of one area could have large and unintended impacts on another. Core v3 brings much more structure and separation of components than any previous Core version.

## Getting Started

Solar Core is built with testing in mind to ensure that breaking changes or bugs are caught before they make it into a release. There are 4 types of tests that we employ to ensure that we catch as many issues as possible and keep feedback during development fast and useful.
...
It is important to understand that Solar Core v3.0 is a massive improvement over every version of Solar Core released thus far. To get a deeper understanding of how it all works, check out our Let's Explore Solar Core Series that examines the upgrades and improvements the development team made to the Core infrastructure:

- **[Part 1: Infrastructure](https://solar.io/blog/lets-explore-solar-core-v3-part-1-infrastructure-5c8ba13c9c42)**
- **[Part 2: Bootstrap and Events](https://solar.io/blog/lets-explore-core-v3-part-2-bootstrap-events-f24adf70dfff)**
- **[Part 3: Kernel and Services](https://solar.io/blog/lets-explore-core-part-3-kernel-services-2836756675bd)**
- **[Part 4: Extensibility](https://solar.io/blog/lets-explore-core-part-4-extensibility-c60522f1b700)**
- **[Part 5: Maintainability and Testability](https://solar.io/blog/lets-explore-core-part-5-maintainability-testability-e40dfee1fe10)**
- **[Part 6: Tooling](https://solar.io/blog/lets-explore-core-part-6-tooling-939d3b6b50df)**
...
The objectives of this test period is to ensure that the Core 3.0's feature set function as designed, identify potential pain points and areas for improvement, and to report any bugs or defects to the SXP.io Team.

## Preparation

Throughout this documentation, we will be using various tools to test Core V3.0 that have been upgraded to be compatible with the latest release of Solar Core.
...
- **Windows** can be found **[here](https://github.com/ArkEcosystem/desktop-wallet/releases/download/2.9.5/solar-desktop-wallet-win-2.9.5.exe)**
- **macOS** can be found **[here](https://github.com/ArkEcosystem/desktop-wallet/releases/download/2.9.5/solar-desktop-wallet-mac-2.9.5.dmg)**
- **Linux** can be found here: **[(32-bit)](https://github.com/ArkEcosystem/desktop-wallet/releases/download/2.9.5/solar-desktop-wallet-linux-x64-2.9.5.tar.gz)** | **[(64-bit)](https://github.com/ArkEcosystem/desktop-wallet/releases/download/2.9.5/solar-desktop-wallet-linux-amd64-2.9.5.deb)**
...
The `core-tx-tester` is a useful tool that allows you to send transactions on the SXP Development Network via command line and may be preferable to the Desktop Wallet. You can find a set up guide for the `core-tx-tester` below:
<livewire:embed-link url="https://github.com/ArkEcosystem/core-tx-tester" caption="Solar Core-TX-Tester" />
...
All of the issues will need to be opened via SXP’s Core Github repository at [http://github.com/arkecosystem/core/issues](http://github.com/arkecosystem/core/issues) with detailed information on what the bug does, how to reproduce the bug, and even a potential solution. If you’re suggesting an improvement then please provide detailed information on what feature/performance/improvement can be implemented.

## Transactions

Transactions are an integral component of the Solar Core Framework and requires thorough testing to ensure that not only each transaction type can be sent successfully but also that our surrounding products display the correct detail where applicable.
