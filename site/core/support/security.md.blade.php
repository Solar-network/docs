...
_Examples: making SXP out of thin air, spending someone else’s SXP without the need of their private keys, replaying the same transaction multiple times without the need of private keys, exposing private keys via public methods, taking control of the entire network, permanently forking the network or a way to permanently destroy the integrity of the SXP blockchain without requiring a malicious delegate._
...
To report a possible security vulnerability, please include your Name, preferred contact information, a full disclosure report, and a method to reproduce the issue being reported and email the information to [security@solar.io](mailto:security@solar.io) with the title "Security Vulnerability Report".
...
_Disclaimer: Category of the severity of the disclosure and all monetary decisions are at the sole discretion of the SXP.io Team and are final. Exploits that make indirect use of already known issues may not be eligible for payment. Examples are for reference only and do not impact or predict potential classification or payment. Past evaluations of security vulnerabilities are not indicative of future evaluations. Security vulnerabilities are paid in SXP or BTC based on the daily average rate before the payout at the sole discretion of the SXP.io Team. Please direct any questions to_ [security@solar.io](mailto:security@solar.io) _with the title "SV Program Help"._
