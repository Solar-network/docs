...
<x-general.sidebar-link path="/docs/desktop-wallet/introduction-to-solar-rewards" name="SXP Rewards (Staking)" />
<x-general.sidebar-link path="/docs/desktop-wallet/cryptoasset-integrations" name="Cryptoasset Integrations" />

## Transactions

<x-general.sidebar-link path="/docs/desktop-wallet/user-guides/how-to-send" name="Send SXP Transfer" />
