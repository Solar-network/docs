...
**Our primary focus at SXP has always been on development. Without an amazing product, nothing else ultimately matters. In an open-source project such as SXP, advancing the codebase to the next level requires help from the wider community. With our Development Bounty Program, anyone can participate and earn rewards for contributions in SXP.**

> SXP’s GitHub is available at [https://github.com/ArkEcosystem](https://github.com/ArkEcosystem).
...
***Since SXP often hires from the community, this program is also a way to show your enthusiasm, skills, ethics and could lead to a position as a full-time developer for SXP. Few of our current developers started their journey with participation in our GitHub program.***
...
Payments will be made at the beginning of each month for the prior month and will be paid in SXP with USD valuation at the time of the payout.
...
*Submitting PR (Pull-Request) is a tacit agreement of the ongoing terms. The decision of the monetary reward is the sole responsibility of the SXP team, and no appeals will be taken. We reserve the right to change any rules and rewards, as well as cancel this program at any time.*
