...
Let's look at the [relay:run](https://github.com/Swipechain/swipechain-core/blob/develop/packages/core/src/commands/relay/run.ts) command in greater detail:
