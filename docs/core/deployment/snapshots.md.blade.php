...
[2021-06-29 08:11:29.688] INFO : Snapshot is saved on location: .../solar-core/mainnet/snapshots/1-153/
...
First, let’s stop the SXP Relay process, if we have it currently running, with:
...
```bash
solar snapshot:restore --blocks=<folder name>
...
solar snapshot:restore --blocks=1-153
```
...
First, let’s stop the SXP Relay process with:
...
```bash
solar snapshot:rollback --height=<height>
...
solar snapshot:rollback --height=7738000
```
...
```bash
solar snapshot:rollback --number=<number>
...
solar snapshot:rollback --number=2000
```
...
```bash
scp -r /home/solar/.local/share/solar-core/<network>/snapshots/<folder-name> <username>@IP:/home/solar/.local/share/solar-core/<network>/snapshots/<folder-name>

// to put this into a practical example:

scp -r /home/solar/.local/share/solar-core/mainnet/snapshots/1-7739894 solar@111.11.11.1:/home/solar/.local/share/solar-core/mainnet/snapshots/1-7739894
```
...
solar@<ip>'s password: inputpasswordhere
```
