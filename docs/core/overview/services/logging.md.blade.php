...
> The default logger that ships with Solar Core is an implementation of [pino](https://github.com/pinojs/pino) with support for console and file streams.
...
The application logger is accessible through the `log` property of the `app` instance. The logger contract that is provided by Solar Core follows the log levels defined in the [RFC 5424 specification](https://tools.ietf.org/html/rfc5424).
