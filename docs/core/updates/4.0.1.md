...
❗ Time-critical update - The new voting mechanism, new transfers, and temporary delegate resignations will be available from block 1,175,000 on 15th July 2022.❗
</span><br/><br/>
...
> See all of the changes -- including hundreds of improvements, optimisations, and bug fixes -- here: [https://github.com/Solar-network/core/compare/3.3.0...4.0.1](https://github.com/Solar-network/core/compare/3.3.0...4.0.1)
...
<span style="color:red">
❗ Note that <b>Ubuntu</b> <code><= 18.x</code> and <b>Debian</b> <code><= 9</code> are no longer supported. ❗ 
</span>
...
> Visit Solar Core's documentation to see an example of the v3 Transfer structure [here](/core/transactions/types/transfer).
...
```
> See the Python code example [here](/sdk/python/complementary-examples.md#creating-and-broadcasting-a-transfer).
...
> Visit Solar Core's documentation to see an example of the v3 Vote structure [here](/core/transactions/types/vote-unvote).
...
> Visit Solar Core's documentation to see an example of the v3 Delegate Resignation structure [here](/core/transactions/types/delegate-resignation).
