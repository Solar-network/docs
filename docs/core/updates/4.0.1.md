...
!!! info
    ...
    <a href="https://github.com/Solar-network/core/compare/3.3.0...4.0.1" target="_blank" rel="noopener noreferrer">github.com/Solar-network/core/compare/3.3.0...4.0.1</a>
