...
<x-alert type="info">
To **create a simple transaction and post it to the local running blockchain** use the **core-tester-cli** package (link below). **Core-Tester** provides set of instructions on how to run commands for creating and sending transactions across any Solar Core network from the CLI interface.
</x-alert>
