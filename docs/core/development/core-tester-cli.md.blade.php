...
Let's jump to the `core-tester-cli` inside the Solar Core repository. The plugin can be found in the `core/packages/core-tester-cli` folder. Tester-CLI has four basic commands available:
