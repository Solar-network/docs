...
Everything we use inside SXP core is built with modules. To learn more about modules and their structure follow the source code of existing modules within core.
</x-alert>

<x-alert type="info">
GitHub learning repository has a template project available [here](https://github.com/learn-solar/dapp-core-module-template/tree/develop). You can create a new module by creating a [new GitHub repository](https://github.com/new) and selecting the correct template: **learn-solar/dapp-core-module-template**.
</x-alert>
