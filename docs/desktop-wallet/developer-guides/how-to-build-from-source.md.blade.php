...
The official SXP Desktop Wallet is an open-source, cross-platform and MIT-licensed project maintained by the SXP Team & Community.

It is an Electron-based JavaScript app developed with Vue.js & Tailwind CSS using the Node v12 runtime.

The SXP Desktop Wallet's source code can be found at the following link: [https://github.com/ArkEcosystem/desktop-wallet](https://github.com/ArkEcosystem/desktop-wallet)
...
Node.js v12 is the supported runtime for the SXP Desktop Wallet.
...
Below is a list of useful `yarn` commands for building, testing and packaging the SXP Desktop Wallet.
...
[MIT](https://github.com/ArkEcosystem/desktop-wallet/blob/develop/LICENSE) © [SXP Ecosystem](https://solar.io)
