module.exports = [
  ...
  //   collapsable: false,
  //   children: [
  //     '/tutorials/usage-guides/how-to-use-swipechain-explorer',
  //     '/tutorials/usage-guides/how-to-use-swipechain-desktop-wallet',
  //     '/tutorials/usage-guides/how-to-use-swipechain-mobile-wallet',
  //     '/tutorials/usage-guides/how-to-vote-in-the-swipechain-desktop-wallet'
  //   ]
  // },
  {
    title: 'Core',
