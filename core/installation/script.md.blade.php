...
<x-alert type="info">
In this example we use **'solar'** for the name of the new user account, but you should use whatever username was set in previous steps above.
</x-alert>
...
The last step of the required Solar Core configuration is to setup the database parameters.
...
<x-alert type="success">
**Hint:** start a relay instance and log its output by entering the following command into your terminal: **`solar relay:start && pm2 logs`**
</x-alert>
