...
This example dApp enables a new transaction type on the Solar Core blockchain. New transaction types follows existing blockchain protocol. You can fork or view full example code here:

<livewire:embed-link url="https://github.com/learn-solar/dapp-custom-transaction-example/" caption="Custom Transaction Example Source Code" />
...
This means that transactions was accepted into the pool and broadcast to the rest of the network. If you want to create more transaction payloads, just [use the BusinessTransactionBuilder to create and sign the payload data](https://github.com/learn-solar/dapp-custom-transaction-example/blob/master/__tests__/unit/test.test.ts).
