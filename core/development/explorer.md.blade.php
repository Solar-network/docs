...
This short guide will help you setup a local blockchain explorer. This will enable you to browse and search your **local Testnet** (or any other SXP based) blockchain from a web application (exactly the same as in our official [Blockchain Explorer](https://explorer.solar.io)).
