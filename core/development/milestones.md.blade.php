...
Milestones are objects that dictate how Solar Core behaves after certain heights are reached. Lets have a look at the mainnet milestones to understand this better.
...
[
    {
        // From height 75600 onwards we will reward 2 SXP for every forged block
        "height": 75600,
        "reward": 200000000
    },
    {
...
Sometimes you might have the need to get a milestone for a specific height or need all of them to perform some statistical calculations. The `@solar-network/crypto` package makes this easy through its configuration manager that manages the state of the configuration and related milestones.
